  ...
  const handleSelectTemplate = (id) => {
    ...
    if (celeb) {
      ...
      setResumeData(prev => ({
        ...
        experience: (celeb.experience || []).map((e, i) => ({ ...e, id: e.id || String(i + 1) })),
        education: (celeb.education || []).map((e, i) => ({ ...e, id: e.id || String(i + 1) })),
        skills: {
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <div style={{ display: 'flex', gap: '0.25rem' }}>
                  {[1, 2, 3, 4, 5].map(star => (
                    <div key={star} style={{ width: '24px', height: '24px', backgroundColor: '#10B981', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFF' }}>
                ...
                <span style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--text-main)' }}>5,293 Reviews</span>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                  <strong style={{ color: 'var(--text-main)' }}>28,452 users</strong> landed interviews last month
                </span>
              </div>
            </div>
          </div>
