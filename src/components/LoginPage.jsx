...
const LoginPage = () => {
  ...
  // Card slide transition and 3D flip states
  ...
  const handleToggleMode = (signUpMode) => {
    setSlideDirection(signUpMode ? 'right' : 'left');
    setIsSignUp(signUpMode);
    setIsFlipped(false); // Reset to email entry face on card change
    setError('');
    setMessage('');
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <AnimatePresence initial={false} custom={slideDirection} mode="wait">
          ...
          >
            {/* ── STACKED 3D FLIPPING PAGES WRAPPER ── */}
            <div style={{
              perspective: '1500px',
              width: '100%',
              height: '100%',
